<nav id="nav--bg" class="navbar navbar-expand-lg navbar-ligght p-3 fixed-top bg-successm nav-bg">
    <div class="container-fluid">
        <a class="navbar-brand" href="index.php"><img class="img-fluid logo" src="./assets/images/EDURESOURSELAB LOGO.png"
                                                      alt="logo"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav m-auto mb-2 mb-lg-0 ">
                ...
                <li class="nav-item">
                    ...
                    <ul>
                        <li><a class="nav-link active" aria-current="page" href="course-materials.php">NCE COURSE MATERIALS</a></li>
                        <li><a class="nav-link active" aria-current="page" href="#">DEGREE COURSE MATERIALS</a></li>
                    </ul>
                    </div>
                </li>
                <li class="nav-item">
