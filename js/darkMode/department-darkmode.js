...
function darkToggle() {
  ...
  document.getElementById("select--box6").classList.add("select-box-dark");
  ...
  document.getElementById("select--box7").classList.add("select-box-dark");
  document.getElementById("select--box8").classList.add("select-box-dark");
  document.getElementById("select--box9").classList.add("select-box-dark");
  document.getElementById("select--box10").classList.add("select-box-dark");
...
function removeDarkToggle() {
  ...
  document.getElementById("select--box6").classList.remove("select-box-dark");
  ...
  document.getElementById("select--box7").classList.remove("select-box-dark");
  document.getElementById("select--box8").classList.remove("select-box-dark");
  document.getElementById("select--box9").classList.remove("select-box-dark");
  document.getElementById("select--box10").classList.remove("select-box-dark");
